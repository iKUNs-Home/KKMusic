...
import com.ikunkun.kunmusic.util.music.musicImpl.netease.NeteaseCloudMusicInfo;
...
//        final JSONObject login = neteaseCloudMusicInfo.loginCellphone(jsonObject);
        final JSONObject jsonObject = new JSONObject();
        jsonObject.put("id", 1962373924);
        JSONObject songUrl = neteaseCloudMusicInfo.songUrl(jsonObject);
        System.out.println(songUrl);
//        String address = "http://localhost:3000/search/hot";
//        try {
...
//            e.printStackTrace();
//        }
//        final JSONObject songUrl = neteaseCloudMusicInfo.searchHot();
//        System.out.println(songUrl);
